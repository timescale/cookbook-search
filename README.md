...
|---------|-------------|
| [Hybrid Search](./Hybrid-search/) | Combining multiple search strategies (e.g. full-text + vector similarity) for more relevant results |
...
2. Navigate to the cookbook you're interested in
3. Follow the README inside each cookbook folder for setup and usage instructions

## Contributing

Have a search pattern or technique you'd like to add? Open a PR! Each cookbook should include:

- A `README.md` explaining the approach and when to use it
- Example SQL or code demonstrating the technique
- Sample data or instructions for generating it
